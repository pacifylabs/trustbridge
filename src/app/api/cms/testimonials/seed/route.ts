...
import { seedTestimonialsIfEmpty } from '@/lib/cms/testimonials';

/** One-off: loads starter testimonials so editors have real examples to change rather than a blank list. */
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const seeded = await seedTestimonialsIfEmpty();
